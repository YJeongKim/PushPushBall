...
public class ManualController implements MouseListener {
	Manual manual;
	...
	public ManualController(Manual manual, Container contentPane, JFrame frame, Board board, MapData mapdata, Intro intro,BilliardTable billiard, PlayerData playerdata) {
		this.manual = manual;
